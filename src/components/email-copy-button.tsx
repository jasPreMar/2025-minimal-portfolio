  ...
  return (
    <Tooltip delayDuration={750}>
      <TooltipTrigger asChild>
        <motion.button
          className="email-button-chromatic outline-none h-9 flex items-center justify-center whitespace-nowrap rounded-lg focus-visible:ring-1 focus-visible:ring-foreground focus-visible:ring-offset-1 focus:outline-none bg-background text-foreground font-sans text-sm font-medium cursor-pointer relative"
